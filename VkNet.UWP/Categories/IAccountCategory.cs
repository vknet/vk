namespace VkNet.Categories
{
    ...
    /// <summary>
    /// Методы этого интерфейса позволяют производить действия с аккаунтом пользователя.
    /// </summary>
    public interface IAccountCategory
    {
        ...
        /// </remarks>
        InformationAboutOffers GetActiveOffers(ulong? offset = default(ulong?), ulong? count = default(ulong?));
        ...
        /// </remarks>
        VkCollection<User> GetBanned(int? offset = default(int?), int? count = default(int?));
        ...
        /// </remarks>
        LookupContactsResult LookupContacts(List<string> contacts, Services service, string mycontact = null, bool? returnAll = default(bool?), UsersFields fields = null);
        ...
        /// </remarks>
        bool SetNameInMenu([NotNull] string name, long? userId = default(long?));
        ...
        /// </remarks>
        bool SetOnline(bool? voip = default(bool?));
        ...
        /// </remarks>
        bool SetSilenceMode([NotNull] string deviceId, int? time = default(int?), int? peerId = default(int?), bool? sound = default(bool?));
        ...
        /// </remarks>
        bool UnregisterDevice(string deviceId, bool? sandbox = default(bool?));
    }
}