namespace VkNet.Categories
{
	...
	/// </summary>
    public interface IGroupsCategory
    {
        /// <summary>
        ...
        /// </remarks>
        VkCollection<User> GetBanned(long groupId, long? offset = null, long? count = null, GroupsFields fields = null, long? userId = null);
        ...
        /// </remarks>
        Link AddLink(long groupId, Uri link, string text);
        ...
        /// </remarks>
        Group Create(string title, string description, GroupType type, GroupSubType? subtype);
