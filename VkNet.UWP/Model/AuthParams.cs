...
namespace VkNet
{
    ...
    public class AuthParams : IAuthParams
    {
        ...
        /// <summary>
        /// Преобразует структуру ApiAuthParams в класс AuthParams
        /// </summary>
        /// <param name="params"></param>
        /// <returns></returns>
        public static AuthParams GetAuthParams(ApiAuthParams @params)
        {
            return new AuthParams
            {
                ...
                TwoFactorAuthorization = @params.TwoFactorAuthorization,
