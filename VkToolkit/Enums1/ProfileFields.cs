...
namespace VkToolkit.Enums
{
    public sealed class ProfileFields
    {
        ...
        public static readonly ProfileFields All = Uid | FirstName | LastName | Nickname | ScreenName
            | Sex | BirthDay | City | Country | Timezone | Photo50 | Photo100 | Photo200Orig | HasMobile
            | Contacts | Education | Online | Counters | Relation | LastSeen | Status | CanWritePrivateMessage
            | CanSeeAllPosts | CanSeeAudio | CanPost | Universities | Schools | Verified | Connections | Site
            | Relatives | Activities | Interests | Music | Movies | Tv | Books | Games | Quotes | About
            | Lang | Personal | Photo400Orig | PhotoMax | PhotoMaxOrig;
