...
public class DatabaseCategoryTest : CategoryBaseTest
{
	...
	public void GetFaculties_ListVstuFaculties()
	{
		...
		faculties[0]
			.Title.Should()
			.Be("Автоматизированных систем и технологической информатики (бывш. Машиностроительный)");
		...
		faculties[1]
			.Title.Should()
			.Be("Технологии конструкционных материалов");
	...
	public void GetSchools_LiceumsInVolgograd_ListOfLiceums()
	{
		...
		schools[0]
			.Name.Should()
			.Be("Астраханское речное училище (ВФ АРУ)");
	...
	public void GetMetroStations()
	{
		...
		universities.TotalCount.Should()
			.Be(69);
	}
