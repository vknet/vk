...
namespace VkNet.Tests.Categories
{
    ...
    public class UsersCategoryTest : BaseTest
	{
        ...
        {
			Mock.Get(Api.RestClient).Setup(f => f.PostAsync(It.IsAny<Uri>(), It.IsAny<IEnumerable<KeyValuePair<string, string>>>())).Throws(new VkApiException("The remote name could not be resolved: 'api.vk.com'"));
