...
namespace VkNet.Tests.Categories
{
	...
	public class StatsTest
	{
		...
		{
			const string url = "https://api.vk.com/method/stats.get?app_id=1&date_from=2015-11-11&v=5.40&access_token=token";
			const string json =
				@"{
					response: [{
						day: '2015-11-11',
		...
		{
			const string url = "https://api.vk.com/method/stats.get?group_id=1&date_from=2015-11-11&v=5.40&access_token=token";
			const string json =
				@"{
					response: [{
						day: '2015-11-11',
		...
		{
			const string url = "https://api.vk.com/method/stats.trackVisitor?v=5.40&access_token=token";
			const string json =
				@"{
					response: 1
				  }";
