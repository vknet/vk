...
/// <inheritdoc />
/// <summary>
/// Класс для тестирования пропуска ошибок при десериализации StringEnum
/// </summary>
public abstract class EnumDeserializationErrorTest : IDisposable
{
	...
	/// </summary>
	public EnumDeserializationErrorTest()
	{
		...
		SetupCaptchaHandler();
		Api.DeserializationErrorHandler = true;
