...
namespace VkNet.Abstractions
{
    ...
    public interface IDocsCategory : IDocsCategoryAsync
    {
        ...
        /// </remarks>
        VkCollection<Document> Get(int? count = null, int? offset = null, long? ownerId = null,
            DocFilter? type = null);
        ...
        /// </summary>
        /// <param name="file">JSON-объект с полем file, возвращаемый после успешной загрузки документа сервер. Обязательный параметр.</param>
        ...
        /// </remarks>
        ReadOnlyCollection<Document> Save(string file, string title, string tags = null, long? captchaSid = null,
        ...
        /// </remarks>
        long Add(long ownerId, long docId, string accessKey = null, long? captchaSid = null,
            string captchaKey = null);
