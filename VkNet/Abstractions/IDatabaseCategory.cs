...
namespace VkNet.Abstractions
{
	...
	public interface IDatabaseCategory : IDatabaseCategoryAsync
	{
		...
		///     Если не задан параметр <paramref name="parameters.query" />, то будет возвращен список самых крупных городов в
		///     заданной стране.
		///     Если задан параметр <paramref name="parameters.query" />, то будет возвращен список городов, которые релевантны
		///     поисковому запросу.
