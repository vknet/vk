...
namespace VkNet.Abstractions
{
    ...
    /// </summary>
    public interface IAppsCategory
    {
        /// <summary>
        ...
        /// </remarks>
        VkCollection<User> GetFriendsList(AppRequestType type, bool? extended = null, long? count = null, long? offset = null, UsersFields fields = null);
        ...
        /// Страница документации ВКонтакте http://vk.com/dev/apps.getCatalog
        /// </remarks>
        ReadOnlyCollection<App> GetCatalog(out long totalCount, AppGetCatalogParams @params);
        ...
        /// Страница документации ВКонтакте http://vk.com/dev/apps.get
        /// </remarks>
        ReadOnlyCollection<App> Get(out long totalCount, AppGetParams @params);
        ...
        /// Страница документации ВКонтакте http://vk.com/dev/apps.getFriendsList
        /// </remarks>
        ReadOnlyCollection<User> GetFriendsList(out long totalCount, AppRequestType type, bool? extended = null, long? count = null, long? offset = null, UsersFields fields = null);
    }
}