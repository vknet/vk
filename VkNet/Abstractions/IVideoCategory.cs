...
namespace VkNet.Abstractions
{
    public interface IVideoCategory
    {
        ...
        /// </remarks>
        VkCollection<Video> GetUserVideos(long? userId, long? offset, long? count, bool? extended);
        ...
        /// </remarks>
        ReadOnlyCollection<Tag> GetTags(long videoId, long? ownerId);
        ...
        /// </remarks>
        long PutTag(long videoId, long userId, long? ownerId, string taggedName);
        ...
        /// </remarks>
        bool RemoveTag(long tagId, long videoId, long? ownerId);
        ...
        /// </remarks>
        VkCollection<Video> GetNewTags(int? count = null, int? offset = null);
        ...
        /// </remarks>
        Video GetAlbumById(long albumId, long? ownerId = null);
        ...
        /// </remarks>
        bool GetAlbumsByVideo(long? targetId, long ownerId, long videoId, bool? extended);
        ...
        /// </remarks>
        ReadOnlyCollection<VideoCatalog> GetCatalog(long? count, long? itemsCount, string from, bool? extended);
