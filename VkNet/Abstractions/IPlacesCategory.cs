...
namespace VkNet.Abstractions
{
	...
	public interface IPlacesCategory : IPlacesCategoryAsync
	{
		...
		/// </summary>
		/// <param name="places">
		///     Перечисленные через запятую идентификаторы мест список положительных чисел, разделенных запятыми, обязательный
		///     параметр
		/// </param>
		/// <returns>
		...
		///     Также, при наличии соответствующей информации, в объект могут включаться поля checkins, updated, type, country,
		///     city, address.
		/// </returns>
		/// <remarks>
		...
		/// </param>
		/// <returns>
		///     После успешного выполнения возвращает количество отметок и массив объектов chekin, каждый из которых имеет
		///     следующие поля:
		...
		///     place_icon.
		///     Если не заданы параметры latitude и longitude или параметр place, то будет возвращена лента обновлений отметок
		///     друзей. При указании параметра timestamp будут возвращены только те отметки из ленты обновлений, которые были
		///     созданы после указанного значения timestamp. Если timestamp не указан, то отметки из ленты будут возвращены с
		///     учетом параметров offset и count (если они заданы).
		///     Если заданы параметры latitude и longitude, то будут возвращены все отметки, сделанные за последние 24 часа,
		///     координаты которых находятся недалеко от Вас. Если задан параметр friends_only, то будут возвращены только
		///     последние ближайшие отметки Ваших друзей.
		///     Если задан параметр place, то будут возвращены последние 20 отметок, сделанные в месте с идентификатором, указанном
		///     в параметре place.
		///     Если задан параметр uid, то будут возвращены последние 20 отметок, сделанные пользователем с идентификатором,
		...
		/// </param>
		/// <returns>
		///     После успешного выполнения возвращает общее количество найденных мест и массив объектов place, каждый из которых
