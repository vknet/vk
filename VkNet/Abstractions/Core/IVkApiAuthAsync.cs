...
namespace VkNet.Abstractions
{
	...
	public interface IVkApiAuthAsync : IVkApiAuth
	{
		...
		Task AuthorizeAsync(IApiAuthParams @params, CancellationToken cancellationToken = default);

		/// <inheritdoc cref="IVkApiAuth.RefreshToken"/>
		Task RefreshTokenAsync(Func<string> code = null, CancellationToken cancellationToken = default);
