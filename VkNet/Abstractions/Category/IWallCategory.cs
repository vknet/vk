...
public interface IWallCategory : IWallCategoryAsync
{
	...
	/// <inheritdoc cref="IWallCategoryAsync.GetByIdAsync(IEnumerable{string}, bool, long?, ProfileFields, bool)"/>
	...
	/// <inheritdoc cref="IWallCategoryAsync.GetByIdAsync(IEnumerable{string}, long?, ProfileFields, bool)"/>
