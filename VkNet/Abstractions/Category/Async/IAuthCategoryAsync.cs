...
namespace VkNet.Abstractions
{
	...
	public interface IAuthCategoryAsync
	{
		...
		/// </remarks>
		Task<bool> CheckPhoneAsync(string phone, string clientSecret, long? clientId = null, bool? authByPhone = null, CancellationToken cancellationToken = default);
		...
		/// </remarks>
		Task<string> SignupAsync(AuthSignupParams @params, CancellationToken cancellationToken = default);
		...
		/// </remarks>
		Task<AuthConfirmResult> ConfirmAsync(AuthConfirmParams @params, CancellationToken cancellationToken = default);
		...
		/// </remarks>
		Task<string> RestoreAsync(string phone, string lastName, CancellationToken cancellationToken = default);
	}
}