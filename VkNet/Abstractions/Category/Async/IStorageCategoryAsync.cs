...
namespace VkNet.Abstractions
{
	...
	public interface IStorageCategoryAsync
	{
		...
		/// </remarks>
		Task<ReadOnlyCollection<StorageObject>> GetAsync(IEnumerable<string> keys = null, ulong? userId = null, bool? global = null, CancellationToken cancellationToken = default);
		...
		/// </remarks>
		Task<ReadOnlyCollection<string>> GetKeysAsync(ulong? userId = null, bool? global = null, ulong? offset = null, ulong? count = null, CancellationToken cancellationToken = default);
		...
		/// </remarks>
		Task<bool> SetAsync(string key, string value = null, ulong? userId = null, bool? global = null, CancellationToken cancellationToken = default);
	}
}