...
public interface IMessagesCategoryAsync
{
	...
	/// </remarks>
	Task<GetByConversationMessageIdResult> GetByConversationMessageIdAsync(long peerId, [NotNull] IEnumerable<ulong> conversationMessageIds,
	...
	/// </summary>
	/// <param name="chatId">
	/// Идентификатор беседы. список целых чисел, разделенных запятыми (Список целых
	/// чисел, разделенных
	/// запятыми).
	/// </param>
	/// <param name="nameCase">
	...
	/// </remarks>
	[Obsolete(ObsoleteText.MessageGetChatUsers)]
	Task<List<long>> GetChatUsersAsync(long chatId, NameCase nameCase);
	...
	/// </remarks>
	[Obsolete(ObsoleteText.MessageGetChatUsers)]
	Task<List<long>> GetChatUsersAsync(IEnumerable<long> chatIds, NameCase nameCase);
	...
	/// </remarks>
	[Obsolete(ObsoleteText.MessageGetChatUsers)]
	Task<ReadOnlyCollection<User>> GetChatUsersAsync(long chatId, UsersFields fields, NameCase nameCase);
