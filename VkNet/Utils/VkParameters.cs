...
public class VkParameters : Dictionary<string, string>
{
	...
	public void Add<T>(string name, List<T> collection) => Add(name, (IEnumerable<T>) collection);
	...
	public void Add(string name, DateTime dateTime) => Add(name, (DateTime?) dateTime);
	...
	public void Add(string name, bool? nullableValue)
	{
		...
		base.Add(name, nullableValue.Value
			? "1"
			: "0");
	}
