// Autogenerated at 21.11.2015 5:12:02
...
namespace VkNet.Utils
{
    partial class VkResponse
    {
		...
		public static implicit operator DialogsGetObject(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  DialogsGetObject.FromJson(response);
        }

		public static implicit operator Collection<DialogsGetObject>(VkResponse response)
        {
            return response.ToCollectionOf<DialogsGetObject>(a => a);
        }
