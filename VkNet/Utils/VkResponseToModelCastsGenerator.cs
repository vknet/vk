// Autogenerated at 14.01.2016 14:34:14
...
namespace VkNet.Utils
{
    partial class VkResponse
    {
		...
		public static implicit operator Product(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  Product.FromJson(response);
        }

		public static implicit operator Collection<Product>(VkResponse response)
        {
            return response.ToCollectionOf<Product>(a => a);
        }
		public static implicit operator ProductAlbum(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  ProductAlbum.FromJson(response);
        }

		public static implicit operator Collection<ProductAlbum>(VkResponse response)
        {
            return response.ToCollectionOf<ProductAlbum>(a => a);
        }
		public static implicit operator ProductCategory(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  ProductCategory.FromJson(response);
        }

		public static implicit operator Collection<ProductCategory>(VkResponse response)
        {
            return response.ToCollectionOf<ProductCategory>(a => a);
        }
		public static implicit operator ProductCategorySection(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  ProductCategorySection.FromJson(response);
        }

		public static implicit operator Collection<ProductCategorySection>(VkResponse response)
        {
            return response.ToCollectionOf<ProductCategorySection>(a => a);
        }
		public static implicit operator ProductComment(VkResponse response)
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  ProductComment.FromJson(response);
        }

		public static implicit operator Collection<ProductComment>(VkResponse response)
        {
            return response.ToCollectionOf<ProductComment>(a => a);
        }
