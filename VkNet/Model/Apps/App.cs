...
public class App
{
	...
	/// <returns> </returns>
	public static App FromJson(VkResponse response) => new()
	{
		Id = response["id"],
		...
		Screenshots = response["screenshots"]
			.ToReadOnlyCollectionOf<Photo>(o => o),
		...
		ScreenOrientation = response["screen_orientation"]
			.ToEnum<ScreenOrientation>()
	};
