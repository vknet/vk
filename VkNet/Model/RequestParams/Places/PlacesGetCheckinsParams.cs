...
namespace VkNet.Model.RequestParams
{
	...
	public class PlacesGetCheckinsParams
	{
		...
		/// <summary>
		///     смещение относительно первой отметки для выборки определенного подмножества. Игнорируется, если установлен
		///     ненулевой timestamp.
		/// </summary>
		...
		/// <summary>
		///     1 — указывает, что следует выводить только отметки друзей, если заданы географические координаты.
