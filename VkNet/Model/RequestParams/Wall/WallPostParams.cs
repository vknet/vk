...
public class WallPostParams
{
	...
	/// <summary>
	/// <para>Определяет формат отображения прикреплённых медиа файлов.</para>
	/// По умолчанию они располагаются в виде карусели,
	/// где пользователь может просматривать их по одному как слайд-шоу.
	...
	/// пользователя, разместившего запись), 0 — подписи добавлено не будет.
	/// Параметр учитывается только при публикации на
	/// стене сообщества и указании параметра
	/// from_group. По умолчанию подпись не добавляется.
	...
	/// записи будет отложена до указанного времени.
	/// Положительное число.
	/// </summary>
