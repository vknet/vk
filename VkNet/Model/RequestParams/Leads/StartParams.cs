...
namespace VkNet.Model.RequestParams.Leads
{
	...
	{
		/// <summary>
		/// идентификатор рекламной акции, доступный в интерфейсе тестирования рекламных акций. 
		/// </summary>
		...
		/// <summary>
		/// идентификатор пользователя, для которого необходимо получить сессию рекламной акции. 
		/// </summary>
		[JsonProperty("uid")]
		...
		/// Если 0, при завершении рекламной акции голоса будут зачислены на счет пользователя. 
		/// </summary>
		[JsonProperty("aid")]
		...
		/// 0 - запустить рекламную акцию в боевом режиме (рекламная акция должна быть одобрена). 
		/// </summary>
