...
namespace VkNet.Model.RequestParams
{
	...
	public class PhotoGetAllParams
	{
		...
		/// <summary>
		///     <c>false</c> — вернуть все фотографии, включая находящиеся в сервисных альбомах, таких как "Фотографии на моей
		///     стене" (по умолчанию).
		/// </summary>
		...
		/// <summary>
		///     <c>true</c> — не возвращать фотографии, скрытые из блока над стеной пользователя (параметр учитывается только при
