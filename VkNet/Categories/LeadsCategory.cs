...
public partial class LeadsCategory : ILeadsCategory
{
	...
	/// <inheritdoc />
	public LeadsComplete Complete(string vkSid, string secret, string comment) => _vk.Call<LeadsComplete>("leads.complete"
		, new()
		{
			{
				"vk_sid", vkSid
	...
	/// <inheritdoc />
	public Lead GetStats(ulong leadId, string secret, string dateStart, string dateEnd) => _vk.Call<Lead>("leads.getStats"
		, new()
		{
			{
				"lead_id", leadId
	...
	/// <inheritdoc />
	public MetricHitResponse MetricHit(string data) => _vk.Call<MetricHitResponse>("leads.metricHit"
		, new()
		{
			{
				"data", data
