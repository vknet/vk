...
namespace VkNet.Categories
{
    ...
    public partial class AppsCategory
    {
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Apps.SendRequest(@params));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Apps.DeleteAppRequests());
        }
        ...
        /// </remarks>
        public async Task<VkCollection<User>> GetFriendsListAsync(AppRequestType type, bool? extended = null, long? count = null, long? offset = null,
            UsersFields fields = null)
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Apps.GetFriendsList(type, extended, count, offset));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Apps.GetScore(userId));
        }
    }
}