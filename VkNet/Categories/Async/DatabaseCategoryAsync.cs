...
public partial class DatabaseCategory
{
	...
	public Task<VkCollection<Country>> GetCountriesAsync(bool? needAll = null,
		...
		TypeHelper.TryInvokeMethodAsync(() => GetCountries(needAll, codes, count, offset));
	...
	public Task<VkCollection<Region>> GetRegionsAsync(int countryId,
													...
													int? offset = null,
													CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetRegions(countryId, query, count, offset));
	...
	public Task<VkCollection<University>> GetUniversitiesAsync(int countryId,
																...
																int? offset = null,
																CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetUniversities(countryId, cityId, query, count, offset));
	...
	public Task<VkCollection<School>> GetSchoolsAsync(int cityId,
													...
													int? count = null,
													CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetSchools(cityId, query, offset, count));
	...
	public Task<VkCollection<Faculty>> GetFacultiesAsync(long universityId,
														...
														int? offset = null,
														CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetFaculties(universityId, count, offset));

	/// <inheritdoc />
	public Task<ReadOnlyCollection<SchoolClass>> GetSchoolClassesAsync(long countryId,
																		CancellationToken token) =>
		TypeHelper.TryInvokeMethodAsync(() => GetSchoolClasses(countryId));
	...
	public Task<VkCollection<Chair>> GetChairsAsync(long facultyId,
													...
													int? offset = null,
													CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetChairs(facultyId, count, offset));
	...
	public Task<VkCollection<MetroStation>> GetMetroStationsAsync(ulong cityId,
																...
																bool extended = false,
																CancellationToken token = default) =>
		TypeHelper.TryInvokeMethodAsync(() => GetMetroStations(cityId, offset, count, extended));
}