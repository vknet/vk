...
public partial class FaveCategory
{
	...
	/// <inheritdoc/>
	public Task<VkCollection<FaveTag>> GetTagsAsync(CancellationToken token = default) => TypeHelper.TryInvokeMethodAsync(GetTags, token);

	/// <inheritdoc/>
	public Task<bool> MarkSeenAsync(CancellationToken token = default) => TypeHelper.TryInvokeMethodAsync(MarkSeen, token);
