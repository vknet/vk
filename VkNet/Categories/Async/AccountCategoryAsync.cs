...
namespace VkNet.Categories
{
    public partial class AccountCategory
    {
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetNameInMenu(name, userId));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetOnline(voip));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetOffline());
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.RegisterDevice(@params));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.UnregisterDevice(deviceId, sandbox));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetSilenceMode(deviceId, time, peerId, sound));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.GetPushSettings(deviceId));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetPushSettings(deviceId, settings, key, value));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.GetAppPermissions(userId));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.GetActiveOffers(offset, count));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.BanUser(userId));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.UnbanUser(userId));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.GetBanned(offset, count));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SetInfo(name, value));
        }
        ...
        /// </remarks>
        public async Task<AccountChangePasswordResult> ChangePasswordAsync(string oldPassword, string newPassword, string restoreSid = null,
            string changePasswordHash = null)
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.ChangePassword(oldPassword, newPassword, restoreSid, changePasswordHash));
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.GetProfileInfo());
        }
        ...
        {
            return await TypeHelper.TryInvokeMethodAsync(() => _vk.Account.SaveProfileInfo(cancelRequestId));
        }
