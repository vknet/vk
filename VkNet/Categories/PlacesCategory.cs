...
namespace VkNet.Categories
{
	...
	public partial class PlacesCategory : IPlacesCategory
	{
		...
		{
			return _vk.Call<object>("places.add",
				new VkParameters
				{
		...
		{
			return _vk.Call<object>("places.checkin",
				new VkParameters
				{
		...
		{
			return _vk.Call<IEnumerable<object>>("places.getById", new VkParameters {{"places", places}});
		}

		/// <inheritdoc/>
		public IEnumerable<object> GetCheckins(PlacesGetCheckinsParams placesGetCheckinsParams)
		{
			return _vk.Call<IEnumerable<object>>("places.getCheckins",
				new VkParameters
				{
		...
		{
			return _vk.Call<IEnumerable<object>>("places.getTypes", VkParameters.Empty);
		}

		/// <inheritdoc/>
		public Uri Search(PlacesSearchParams placesSearchParams)
		{
			return _vk.Call<Uri>("places.search",
				new VkParameters
				{
