namespace VkNet.Enums.Filters
{
    ...
    public sealed class ProfileFields : MultivaluedFilter<ProfileFields>
    {
        ...
        public static readonly ProfileFields All = Uid | FirstName | LastName | Sex | BirthDate | City | Country 
                                                   | Photo50 | Photo100 | Photo200 | Photo200Orig | Photo400Orig 
                                                   | PhotoMax | PhotoMaxOrig | Online | FriendLists | Domain | HasMobile 
                                                   | Contacts | Connections | Site | Education | Universities | Schools 
                                                   | CanPost | CanSeeAllPosts | CanSeeAudio | CanWritePrivateMessage 
                                                   | Status | LastSeen | CommonCount | Relation | Relatives | Counters 
                                                   | Nickname | Timezone | Language | OnlineMobile | OnlineApp 
                                                   | RelationPartner | StandInLife | Interests | Music | Activities 
                                                   | Movies | Tv | Books | Games | About | Quotes | InvitedBy
                                                   | BlacklistedByMe | Blacklisted | Military | Career | FriendStatus
                                                   | IsFriend | ScreenName | IsHiddenFromFeed | IsFavorite
                                                   | CanSendFriendRequest | WallComments | Verified | FollowersCount
                                                   | CropPhoto | Exports | MaidenName | PhotoId;
    }
}