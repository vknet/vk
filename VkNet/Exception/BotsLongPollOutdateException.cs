...
namespace VkNet.Exception
{
	...
	public class BotsLongPollOutdateException : LongPollException
	{
		...
		/// <inheritdoc />
		public BotsLongPollOutdateException(ulong ts) : base(1, "История событий устарела или была частично утеряна, приложение может получать события далее, используя новое значение ts из ответа.")
		{
			Ts = ts;
		}
	}
