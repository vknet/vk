...
namespace VkNet.Exception
{
    ...
    public class InvalidAppIdException : VkApiMethodInvokeException
    {
        ...
        public InvalidAppIdException(string message, System.Exception innerException) : base(message, innerException)
        {
        }
        ...
        public InvalidAppIdException(string message, int code) : base(message, code)
        {
        }
        ...
        public InvalidAppIdException(VkResponse response) : base(response["error_msg"])
        {
