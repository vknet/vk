...
namespace VkNet.Exception
{
	...
	public class AdsRecentlyPostedException : VkApiMethodInvokeException
	{
		...
		public AdsRecentlyPostedException(string message) : base(message: message)
		{
		}
		...
		public AdsRecentlyPostedException(string message, System.Exception innerException) : base(message: message
		...
		public AdsRecentlyPostedException(string message, int code) : base(message: message, code: code)
		{
		}
