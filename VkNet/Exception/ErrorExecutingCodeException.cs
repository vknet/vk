...
namespace VkNet.Exception
{
	...
	public class ErrorExecutingCodeException : VkApiMethodInvokeException
	{
		...
		public ErrorExecutingCodeException(string message) : base(message: message)
		{
		}
		...
		public ErrorExecutingCodeException(string message, System.Exception innerException) : base(message: message
		...
		public ErrorExecutingCodeException(string message, int code) : base(message: message, code: code)
		{
		}
