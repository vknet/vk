namespace VkNet.Tests.Categories
{
	...
	public class AudioCategoryTest : BaseTest
	{
		...
		{
			Url = "https://api.vk.com/method/audio.edit";
			Json =
				@"{
                    'response': 26350163
                  }";
		...
		{
			Url = "https://api.vk.com/method/audio.restore";
			Json =
				@"{
                    'error': {
                      'error_code': 100,
		...
		{
			Url = "https://api.vk.com/method/audio.reorder";
		...
		{
			Url = "https://api.vk.com/method/audio.editAlbum";
			Json =
			@"{
                    'response': 1
                  }";
		...
		{
			Url = "https://api.vk.com/method/audio.deleteAlbum";
			Json =
				@"{
                    'response': 1
                  }";
